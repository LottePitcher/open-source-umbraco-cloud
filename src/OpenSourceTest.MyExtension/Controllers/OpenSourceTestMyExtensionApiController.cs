...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "OpenSourceTest.MyExtension")]
    public class OpenSourceTestMyExtensionApiController : OpenSourceTestMyExtensionApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public OpenSourceTestMyExtensionApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
