...
namespace OpenSourceTest.MyExtension.Composers
{
    public class OpenSourceTestMyExtensionApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Open Source Test My Extension Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<OpenSourceTestMyExtensionOperationSecurityFilter>();
            });
        }

        public class OpenSourceTestMyExtensionOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("OpenSourceTest.MyExtension.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
